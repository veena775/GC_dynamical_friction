...
// gcc -c -O3 -fPIC additional_forces_rho06.83_r029.47.c -o additional_forces_rho06.83_r029.47.o
// gcc -L. -shared additional_forces_rho06.83_r029.47.o -o additional_forces_rho06.83_r029.47.so -lrebound -lgsl -lm
...
void NFW_DF_Petts(struct reb_simulation* const r){
    double r_0 = 29.469794898215007;
    double rho_0 = 6.827675435775152;
