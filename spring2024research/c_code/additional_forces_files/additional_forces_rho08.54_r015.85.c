...
// gcc -c -O3 -fPIC additional_forces_rho08.54_r015.85.c -o additional_forces_rho08.54_r015.85.o
// gcc -L. -shared additional_forces_rho08.54_r015.85.o -o additional_forces_rho08.54_r015.85.so -lrebound -lgsl -lm
...
void NFW_DF_Petts(struct reb_simulation* const r){
    double r_0 = 15.85453793963854;
    double rho_0 = 8.538580249721624;
