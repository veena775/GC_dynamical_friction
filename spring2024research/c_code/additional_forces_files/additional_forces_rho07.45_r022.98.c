...
// gcc -c -O3 -fPIC additional_forces_rho07.45_r022.98.c -o additional_forces_rho07.45_r022.98.o
// gcc -L. -shared additional_forces_rho07.45_r022.98.o -o additional_forces_rho07.45_r022.98.so -lrebound -lgsl -lm
...
void NFW_DF_Petts(struct reb_simulation* const r){
    double r_0 = 22.981548413096945;
    double rho_0 = 7.451433363517789;
