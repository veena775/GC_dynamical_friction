...
// gcc -c -O3 -fPIC additional_forces_rho09.04_r013.81.c -o additional_forces_rho09.04_r013.81.o
// gcc -L. -shared additional_forces_rho09.04_r013.81.o -o additional_forces_rho09.04_r013.81.so -lrebound -lgsl -lm
...
void NFW_DF_Petts(struct reb_simulation* const r){
    double r_0 = 13.810710673493478;
    double rho_0 = 9.03737036471599;
