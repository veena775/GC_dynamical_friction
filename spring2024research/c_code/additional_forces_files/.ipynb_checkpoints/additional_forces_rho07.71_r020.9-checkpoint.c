...
// gcc -c -O3 -fPIC additional_forces_rho07.71_r020.9.c -o additional_forces_rho07.71_r020.9.o
// gcc -L. -shared additional_forces_rho07.71_r020.9.o -o additional_forces_rho07.71_r020.9.so -lrebound -lgsl -lm
...
void NFW_DF_Petts(struct reb_simulation* const r){
    double r_0 = 20.898917575063706;
    double rho_0 = 7.711475358455671;
