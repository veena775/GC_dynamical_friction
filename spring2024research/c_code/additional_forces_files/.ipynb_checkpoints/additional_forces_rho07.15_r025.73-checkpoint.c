...
// gcc -c -O3 -fPIC additional_forces_rho07.15_r025.73.c -o additional_forces_rho07.15_r025.73.o
// gcc -L. -shared additional_forces_rho07.15_r025.73.o -o additional_forces_rho07.15_r025.73.so -lrebound -lgsl -lm
...
void NFW_DF_Petts(struct reb_simulation* const r){
    double r_0 = 25.729421157169533;
    double rho_0 = 7.154327100446665;
