...
// gcc -c -O3 -fPIC additional_forces_rho07.34_r023.98.c -o additional_forces_rho07.34_r023.98.o
// gcc -L. -shared additional_forces_rho07.34_r023.98.o -o additional_forces_rho07.34_r023.98.so -lrebound -lgsl -lm
...
void NFW_DF_Petts(struct reb_simulation* const r){
    double r_0 = 23.984791966295788;
    double rho_0 = 7.337519527766192;
