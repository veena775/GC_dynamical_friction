...
// gcc -c -O3 -fPIC additional_forces_rho010.98_r08.36.c -o additional_forces_rho010.98_r08.36.o
// gcc -L. -shared additional_forces_rho010.98_r08.36.o -o additional_forces_rho010.98_r08.36.so -lrebound -lgsl -lm
...
void NFW_DF_Petts(struct reb_simulation* const r){
    double r_0 = 8.36232808425402;
    double rho_0 = 10.977482469158955;
