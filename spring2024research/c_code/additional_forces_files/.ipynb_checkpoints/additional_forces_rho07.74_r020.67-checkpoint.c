...
// gcc -c -O3 -fPIC additional_forces_rho07.74_r020.67.c -o additional_forces_rho07.74_r020.67.o
// gcc -L. -shared additional_forces_rho07.74_r020.67.o -o additional_forces_rho07.74_r020.67.so -lrebound -lgsl -lm
...
void NFW_DF_Petts(struct reb_simulation* const r){
    double r_0 = 20.671555351631252;
    double rho_0 = 7.7420327703570875;
