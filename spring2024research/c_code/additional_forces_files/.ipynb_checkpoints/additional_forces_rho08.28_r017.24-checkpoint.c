...
// gcc -c -O3 -fPIC additional_forces_rho08.28_r017.24.c -o additional_forces_rho08.28_r017.24.o
// gcc -L. -shared additional_forces_rho08.28_r017.24.o -o additional_forces_rho08.28_r017.24.so -lrebound -lgsl -lm
...
void NFW_DF_Petts(struct reb_simulation* const r){
    double r_0 = 17.239379044146297;
    double rho_0 = 8.277811434586846;
