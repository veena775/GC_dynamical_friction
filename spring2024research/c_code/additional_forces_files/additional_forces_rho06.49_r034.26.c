...
// gcc -c -O3 -fPIC additional_forces_rho06.49_r034.26.c -o additional_forces_rho06.49_r034.26.o
// gcc -L. -shared additional_forces_rho06.49_r034.26.o -o additional_forces_rho06.49_r034.26.so -lrebound -lgsl -lm
...
void NFW_DF_Petts(struct reb_simulation* const r){
    double r_0 =  34.260008099601855;
    double rho_0 = 6.489589521251805;
