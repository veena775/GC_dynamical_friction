...
// gcc -c -O3 -fPIC additional_forces_rho07.08_r026.52.c -o additional_forces_rho07.08_r026.52.o
// gcc -L. -shared additional_forces_rho07.08_r026.52.o -o additional_forces_rho07.08_r026.52.so -lrebound -lgsl -lm
...
void NFW_DF_Petts(struct reb_simulation* const r){
    double r_0 = 26.518144649678433;
    double rho_0 = 7.077051187321043;
