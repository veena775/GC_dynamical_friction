...
// gcc -c -O3 -fPIC additional_forces_rho09.49_r012.2.c -o additional_forces_rho09.49_r012.2.o
// gcc -L. -shared additional_forces_rho09.49_r012.2.o -o additional_forces_rho09.49_r012.2.so -lrebound -lgsl -lm
...
void NFW_DF_Petts(struct reb_simulation* const r){
    double r_0 = 12.202361361113104;
    double rho_0 = 9.494077557843278;
