...
// gcc -c -O3 -fPIC additional_forces_rho06.96_r027.8.c -o additional_forces_rho06.96_r027.8.o
// gcc -L. -shared additional_forces_rho06.96_r027.8.o -o additional_forces_rho06.96_r027.8.so -lrebound -lgsl -lm
...
void NFW_DF_Petts(struct reb_simulation* const r){
    double r_0 = 27.80115339591889;
    double rho_0 = 6.964120659403408;
