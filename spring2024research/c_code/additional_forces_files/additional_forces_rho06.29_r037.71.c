...
// gcc -c -O3 -fPIC additional_forces_rho06.29_r037.71.c -o additional_forces_rho06.29_r037.71.o
// gcc -L. -shared additional_forces_rho06.29_r037.71.o -o additional_forces_rho06.29_r037.71.so -lrebound -lgsl -lm
...
void NFW_DF_Petts(struct reb_simulation* const r){
    double r_0 = 37.71442410414682;
    double rho_0 = 6.289272384377435;
