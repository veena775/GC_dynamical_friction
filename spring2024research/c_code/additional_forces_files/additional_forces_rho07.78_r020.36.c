...
// gcc -c -O3 -fPIC additional_forces_rho07.78_r020.36.c -o additional_forces_rho07.78_r020.36.o
// gcc -L. -shared additional_forces_rho07.78_r020.36.o -o additional_forces_rho07.78_r020.36.so -lrebound -lgsl -lm
...
void NFW_DF_Petts(struct reb_simulation* const r){
    double r_0 = 20.36267349637498;
    double rho_0 = 7.784299709637616;
