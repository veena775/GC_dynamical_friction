...
// gcc -c -O3 -fPIC additional_forces_rho08.73_r015.01.c -o additional_forces_rho08.73_r015.01.o
// gcc -L. -shared additional_forces_rho08.73_r015.01.o -o additional_forces_rho08.73_r015.01.so -lrebound -lgsl -lm
...
void NFW_DF_Petts(struct reb_simulation* const r){
    double r_0 = 15.012960252121019;
    double rho_0 = 8.73150542285457;
