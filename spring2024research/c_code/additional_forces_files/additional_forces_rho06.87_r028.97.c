...
// gcc -c -O3 -fPIC additional_forces_rho06.87_r028.97.c -o additional_forces_rho06.87_r028.97.o
// gcc -L. -shared additional_forces_rho06.87_r028.97.o -o additional_forces_rho06.87_r028.97.so -lrebound -lgsl -lm
...
void NFW_DF_Petts(struct reb_simulation* const r){
    double r_0 = 28.972217285946154;
    double rho_0 = 6.867240297444933;
